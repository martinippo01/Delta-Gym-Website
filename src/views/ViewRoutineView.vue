...
export default {
  ...
  methods: {
    ...
    ...mapActions(useEditeRoutine,['uploadExercises']),
    ...
    ...mapState(useEditeRoutine,['exercises']),
  ...
  computed:{
    ...mapState(useEditeRoutine,['getCoolDownExercises']),
    ...mapState(useEditeRoutine,['getMainSetExercises']),
    ...mapState(useEditeRoutine,['getWarmUpExercises']),

    ...mapState(useExerciseStore,['createdExercise']),
  },
  mounted() {
    console.log(this.$route.name);
    this.routineId = this.$route.params.id? this.$route.params.id:this.routineId;
    this.getRoutineData(this.routineId)
    try {
